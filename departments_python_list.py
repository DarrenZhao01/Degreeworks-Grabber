# UCI Department Codes and Names
# Extracted from AnteaterAPI
...
DEPARTMENTS = [
    ...
    ("CBEMS", "Chemical Engineering and Materials Science"),
    ...
    ("ENGRMSE", "Materials Science and Engineering"),
    ("EPIDEM", "Epidemiology"),
    ...
    ("UPPP", "Urban Policy and Public Planning"),
    ("VIETMSE", "Vietnamese"),
